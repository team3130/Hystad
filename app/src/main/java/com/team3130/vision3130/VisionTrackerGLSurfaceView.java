...
import com.team3130.vision3130.comm.CameraTargetInfo;
import com.team3130.vision3130.comm.RobotConnection;
import com.team3130.vision3130.comm.VisionUpdate;
import com.team3130.vision3130.comm.messages.TargetUpdateMessage;
import com.team3130.vision3130.comm.messages.VisionMessage;
...
public class VisionTrackerGLSurfaceView extends BetterCameraGLSurfaceView implements BetterCameraGLSurfaceView.CameraTextureListener {
    ...
    static BetterCamera2Renderer.Settings getCameraSettings() {
        ...
        settings.camera_settings.put(CaptureRequest.SENSOR_EXPOSURE_TIME, 10000000L); // Originally 1000000L (nanoseconds), increased to 10000000L.  30000000L is too high, looses target detection
